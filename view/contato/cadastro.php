                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="../../controller/UsuarioController.php" method="post">
                                <input type="hidden" name="acao" value="contatoCadastro">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label>Apelido:</label>
                                            <input type="text" name="apelido" class="form-control" required="required">
                                        </div> 
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label>Data de nascimento:</label>
                                            <input type="date" name="dtNascimento" class="form-control" required="required">
                                        </div> 
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12 form-group">
                                            <label>Telefone:</label>
                                            <input type="text" name="telefone" id="telefone" maxlength="15" class="form-control" required="required">
                                        </div> 
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12 form-group">
